...
public class ChatController {
    ...
    private ChatMessageEntity buildChatMessageEntity(ChatMessage message) {
    ...
    private ChatMessage buildChatMessage(ChatMessageEntity e) {
    ...
    private void saveAndSendPrivateMessage(String recipient, ChatMessage message) {
        ...
        ChatMessageEntity entity = buildChatMessageEntity(message);
    ...
    public void markDelivered(@PathVariable Long id) {
        ...
        messageRepository.findById(id).ifPresent(e -> {
            ...
            // notifer sender of delivery
            notificationService.sendPrivateMessage(e.getSender(), e.getClientMessageId(), "/queue/receipts");
        });
    }
}
